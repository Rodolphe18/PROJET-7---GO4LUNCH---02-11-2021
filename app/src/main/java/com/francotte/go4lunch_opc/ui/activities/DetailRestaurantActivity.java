...
public class DetailRestaurantActivity extends AppCompatActivity implements GoogleMapPlacesCall.GetDetailOfPlaceCallbacks, View.OnClickListener, FirestoreCall.CallbackFirestore, FirestoreCall.CallbackFirestoreFavorite {
    ...
    ImageView mIconFavoriteButtonYellow;
    ...
    private Boolean isCurrentUserEatHere = false;
    ...
    private void configureUI() {
        ...
        star1 = findViewById(R.id.item_list_restaurant_star_1_image);
        star2 = findViewById(R.id.item_list_restaurant_star_2_image);
        star3 = findViewById(R.id.item_list_restaurant_star_3_image);
